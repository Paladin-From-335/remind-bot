...
public enum Response {
    ...
    GREETINGS("Hello, I'm a remind bot.\n" +
            "To start press \"Create\" or \"Help\" if you need more information"),
    ...
    INCORRECT_TIME_FORMAT("To start enter your current time\n" +
            "This needed for correct reminding.\n" +
    ...
    HELP_INFO("This bot is created to remind you of something.\n" +
            "Commands:\n" +
            " - <b>/start</b> - start bot;\n" +
            " - <b>Create button</b> - create new remind,\n" +
            " - <b>All reminders</b> - get your reminder list\n" +
            " - <b>Today reminders</b> - get your reminders for today\n" +
